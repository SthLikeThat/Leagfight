<div class="panel panel-default shop-item" data-type="%type_defence%">
  <div class="panel-heading">
      <h4 class="panel-title">
          <div>%name% <h5 style="float: right; margin-top: 0;"> [%type%]</h5></div>
      </h4>
  </div>
  <div class="panel-body">
    ...
    <div class="shop-item-right-info">
        ...
        <div class="shop-item-right-info-block"> 
            <img src="../images/icons/armor.png"> %armor%
        </div>
    </div>	
